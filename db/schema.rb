...
ActiveRecord::Schema.define(version: 20160705144317) do
  ...
  add_index "collaborates", ["actor_id"], name: "index_collaborates_on_actor_id"
  add_index "collaborates", ["director_id"], name: "index_collaborates_on_director_id"
